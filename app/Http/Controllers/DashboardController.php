...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->role == 'admin') {
            ...
            $team_investment = User::whereReferralId(Auth::user()->id)->whereStatus('approved')->wherePlan('standard')->pluck('total_amount')->sum()+ User::whereReferralId(Auth::user()->id)->whereStatus('approved')->wherePlan('standard')->pluck('available_withdraw')->sum();
